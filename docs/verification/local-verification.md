...
| 프로젝트 | artifact bytes |
| --- | ---: |
| starter 01 weekend | 431025 |
| complete 01 weekend | 431022 |
| starter 02 habit | 431465 |
| complete 02 habit | 431496 |
| starter 03 travel | 431317 |
| complete 03 travel | 431316 |
| starter 04 gift | 431038 |
| complete 04 gift | 431036 |

local mock-api check와 complete 대표 상태 4개의 브라우저 캡처는 PASS예요. starter 전체 브라우저 분기, Cloudflare dry-run/live, QR/기기, 수동 콘솔 업로드, publication, review, release, revenue는 모두 PENDING이에요. 이 저장소는 커밋·remote·push·공개를 만들지 않았어요.
